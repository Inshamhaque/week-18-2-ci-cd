        ...
        <div>
            <div className="flex justify-between p-5">
                <div className="flex  items-center flex-row">
                    ...
                    <div className="flex items-center flex-row pl-3 text-xs text-slate-800">
            ...
            <div>
                <div class="h-1 border-b-2 border-slate-200 text-xl text-center">
            </div>
